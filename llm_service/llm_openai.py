...
publication_date: Muestra la fecha del periódico, el nombre del archivo contiene la fecha de al inicio YYYY_MM_DD_... en este ejemplo 1876-01-01El nombre del archivo aporta información que se necesita extraer, este nombre tiene el siguiente formato: Ej.: 1876_01_01_HAB_DM_U_01_0_V_003-001.txt
...
travel_departure_date: Indica la fecha de salida del barco del puerto de salida, se determina a partir del valor de travel_arrival_date menos travel_duration_value en la unidad de medida dada en travel_duration_unit, por lo que debes tener en cuenta la conversión a días.
...
- cargo: Lista de de mercancias y cada una de ellas se descompone en:
  - cargo_commodity: Expresa los productos o tipos de mercancías que han llegado. Es un valor muy variable, las mercancías más habituales son el carbón o el algodón, pero existe una extraordinaria diversidad de productos que llega al puerto.
...
{{
  "files": ["1876_01_12_HAB_DM_U_01_0_V_003-001.txt",...],
  "publication_date": "1876-01-12", 
  "entries": [
      {{
...
FORMATO DE SALIDA JSON:
{{
  "files": ["1876_01_12_HAB_DM_U_01_0_C_003-001.txt",...],
  "publication_date": "1876-01-12", 
  "entries": [
      {{
        "publication_day": "YYYY-MM-DD",
